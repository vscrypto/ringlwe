#warning "RC4 should not be considered a cryptographically secure pseudorandom number generator due to biases in its keystream output.  See rlwe_kex.c to switch to an AES-based PRNG."
